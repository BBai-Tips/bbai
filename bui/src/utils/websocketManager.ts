...
class WebSocketManager {
  ...
  sendMessage(message: any) {
    if (this.socket && this.socket.readyState === WebSocket.OPEN) {
      ...
      this.error.value =
        "WebSocket is not connected. Please wait or refresh the page.";
    }
  }
...
export const createWebSocketManager = (apiPort: number, startDir: string) =>
  new WebSocketManager(apiPort, startDir);
